...
void WindowView::makeWindowView(){
    ...
    switchPillar->setBrush(Qt::cyan);
    windowPanel = new QGraphicsRectItem(10, 10, 160, 10, this);
    windowPanel->setBrush(Qt::cyan);
...
void WindowView::installMagneticSensor(MagneticSensorView & mv){
    ...
    mv.getMagnetView().setTransformOriginPoint(0, 35);
